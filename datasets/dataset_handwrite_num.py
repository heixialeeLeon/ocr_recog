...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(dataset=test_dataset, num_workers=1, batch_size=1, shuffle=True,
...
# if __name__ == "__main__":
#     with open(config.train_file_list, 'r') as f:
#         file_list = f.readlines()
#     for item in file_list:
#         file_name, label = item.split(' ')
#         file_name = os.path.join(config.image_folder, file_name)
#         print(file_name)
